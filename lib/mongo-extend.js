...
exports.find = co.wrap(function*(collection,query,extend){
    ...
    var _extend = _.defaults(extend,{limit:100,skip:0,select:{},sort:{}});
...
exports.findOneAndDelete = co.wrap(function*(collection,query,update,extra){
    var collection = db.collection(collection);
    var docs = yield collection.findOneAndDelete(query,update,extra);
    return docs;
});
